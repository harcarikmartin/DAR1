...
public class UsersTopics {
	...
	public String toString() {
		return "UsersTopics [topicID=" + topic.getTopicID() + ", "
							+ "topicName=" + topic.getTopic() + ", "
							+ "topicVisibility=" + topic.getVisibility() + ", "
							+ "topicCreatorName=" + topic.getCreator().getUserName() + ", "
							+ "topicCreatorID=" + topic.getCreator().getUserID() + ", "
