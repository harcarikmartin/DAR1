...
<!-- 		<div class="row"> -->
		<div class="paddingHeavy rowBackgroundNone col-lg-9 col-md-9 col-sm-9 col-xs-7">
			<span class="topicHierarchy">${topic.topic}</span>
		</div>


		<div class="paddingHeavy rowBackgroundNone col-lg-3 col-md-3 col-sm-3 col-xs-5">
