...
<div class="row">
	<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 rowBackground">
		<form method="post" onsubmit="return checkRequiredAddTask()">
			...
			<br>
			<div class="row text-center">
				<label class="simpleText" for="bodyOfTask">Write task:</label>
			</div>
			<div class="row text-center">
				<textarea class="inputForNewStuff" id="bodyOfTask" name="bodyOfTask" spellcheck="true" lang="en" cols="50" rows="5" placeholder="body of task ..."
