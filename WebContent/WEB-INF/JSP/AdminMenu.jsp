	...
	<div class="col-lg-offset-1 col-lg-10 rowBackground">
		<div class="text-left text-center-xs">
			<form class="userMenu" method="post">
				...
				<button class="marginHorizontalLeft buttonStyle marginVerticalTop" id="SeeProfile" type="submit">Profile</button>
			</form>
			<form class="userMenu" method="post">
			...
			<form class="userMenu" method="post">
				...
				<button class="marginHorizontalLeft buttonStyle marginVerticalTop" id="ApproveUsers" type="submit">Approve Users</button>
			</form>
			<form class="userMenu" method="post">
				<input type="hidden" name="action" value="userRoles">
				<button class="marginHorizontalLeft buttonStyle marginVerticalTop" id="ApproveUsers" type="submit">User roles</button>
			</form>
			<form class="userMenu" method="post">
				<input type="hidden" name="action" value="addTopic">
				<button class="marginHorizontalLeft buttonStyle marginVerticalTop" id="addTopic" type="submit">Add topic</button>
			</form>
		</div>
	</div>
</div>
	...
	<div class="row col-lg-12">
		<div class="col-lg-offset-1 col-lg-10 col-md-12 col-sm-12 col-xs-12 rowBackground">
			<table class="col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-2 col-xs-8">
				<tr>
					<th colspan="3" class="approveHeadStyle text-center">New users</th>
				</tr>
				<c:forEach items="${pendingUsers}" var="pendingUser">
					<tr>
						<td>
							<p class="approveCellStyle paddingHorizontal">${pendingUser}</p>
						</td>
						<td>
							<form method="post">
	...
	<div class="row">
		<div class="col-lg-offset-1 col-lg-10 col-md-12 col-sm-12 col-xs-12 rowBackground">
			<form method="post" onsubmit="return checkRequiredAddTopic()">
				...
				<div class="row text-center">
					<input class="inputForNewStuff" id="addTheTopic" type="text" name="addTheTopic" placeholder="topic name" required="autofocus" maxlength="100">
				</div>
				<div class="row text-center">
				...
				<div class="row text-center">
					...
					<input id="addPrivate" type="radio" name="visibility" value="private" checked="checked">
	...
	<div class="row">
		<div class="col-lg-offset-1 col-lg-10 col-md-12 col-sm-12 col-xs-12 rowBackground">
			...
			<form method="post" onsubmit="return checkRequiredEditTopic()">
				...
				<div class="row text-center">
					<input class="inputForNewStuff" id="editTopic" type="text" name="editTopic" placeholder="topic name" value="${topicUpdating.topic}"
				...
				<div class="row text-center">
					<c:if test="${topicUpdating.visibility == 'public'}">
						<input type="radio" name="visibility1" value="public" checked="checked">
						<label class="simpleText" for="public">Public</label>
					...
					<c:if test="${topicUpdating.visibility == 'private'}">
						...
						<label class="simpleText" for="public">Public</label>
						<input type="radio" name="visibility1" value="private" checked="checked">
						<label class="simpleText" for="private">Private</label>
					</c:if>
				</div>
				<div class="row text-center">
...
<c:if test="${listUserRoles == 1 && fn:length(users) > 1}">
	<div class="row col-lg-12">
		<div class="col-lg-offset-1 col-lg-10 col-md-12 col-sm-12 col-xs-12 rowBackground">
			<table class="col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8  col-xs-12">
				<tr>
