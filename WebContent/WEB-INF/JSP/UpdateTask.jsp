	...
	<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12 rowBackground">
		<form method="post" onsubmit="return checkRequiredEditTask()">
			<div class="row text-center">
				<label class="simpleText" for="nameOfEditedTask">Edit name of task:</label>
			</div>
			<div class="row text-center">
			...
			<br>
			<div class="row text-center">
				<label class="simpleText" for="bodyOfEditedTask">Edit task:</label>
			</div>
			<div class="row text-center">
				<textarea class="inputForNewStuff" id="bodyOfEditedTask" name="editBodyTask" spellcheck="true" lang="en" cols="50" rows="5"
					placeholder="body of task ..." maxlength="500">${taskUpdating.task}</textarea>
			</div>
			<div class="row text-center">
				<p id="taskBodyRequired" class="requiredField ">Task is required</p>
			</div>
			<div class="row text-center">
