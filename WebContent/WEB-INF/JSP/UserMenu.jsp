	...
	<div class="col-lg-offset-1 col-lg-10 rowBackground">
		<div class="text-left text-center-xs">
			...
			<form class="userMenu" method="post">
				...
				<button class="marginHorizontalLeft buttonStyle marginVerticalTop" type="submit">Subscribed topics</button>
			</form>
		</div>
	</div>
</div>
				...
				<table class="col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-2 col-xs-8">
					<c:forEach var="topic" items="${topics}">
						<c:if test="${topic.visibility == 'private'}">
							<tr>
								<td class="subscribedTopicsTableCell paddingHorizontal text-right">
					...
					<tr>
						...
						<td class="text-left paddingHorizontal subscribedTopicsTableCell">
							<input type="hidden" name="action" value="changeTopics">
							<button class="buttonStyle" type="submit">Subscribe</button>
						</td>
					</tr>
				</table>
			</form>
