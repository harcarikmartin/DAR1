					...
					<table>
						...
						<tr>
							...
							<td class="registerCellStyle text-left">
								<input id="userNameReg" class="registrationForm" type="text" name="userName" placeholder="name" autofocus maxlength="100">
							</td>
							<td class="registerCellStyle text-center">
						...
						<tr>
							...
							<td class="registerCellStyle text-left">
								<input id="userPassReg" class="registrationForm" type="password" name="userPassword"
									pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,}$" oninvalid="alert('Password is not valid')" placeholder="password"
									maxlength="100">
							</td>
							<td class="registerCellStyle text-center">
