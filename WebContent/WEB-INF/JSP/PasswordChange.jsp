			...
			<table class="col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 col-xs-offset-1 col-xs-10">
				<tr>
					<td class="passwordCellStyle">
						<label class="simpleText" for="OldPassword">Old password:</label>
					</td>
					<td class="passwordCellStyle">
				...
				<tr>
					<td class="passwordCellStyle">
						<label class="simpleText" for="NewPassword">New password:</label>
					</td>
					<td class="passwordCellStyle">
						<input id="NewPassword" class="passwordForm" type="password" name="userPasswordNew"
							pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,}$" oninvalid="alert('New password is not valid')" placeholder="password"
							maxlength="100">
					</td>
					<td class="passwordCellStyle text-center">
						<p id="npRequired" class="requiredField">Required field</p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td class="passwordCellStyle">
						<label class="simpleText" for="NewPasswordConfirm">Confirm new password:</label>
					</td>
					<td class="passwordCellStyle">
						<input id="NewPasswordConfirm" class="passwordForm" type="password" name="userPasswordNewCheck" placeholder="password" maxlength="100">
					</td>
					<td class="passwordCellStyle text-center">
						<p id="npcRequired" class="requiredField">Required field</p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3" class="passwordCellStyle text-center">
						...
						<button class="buttonStyle" type="submit">Change</button>
					</td>
				</tr>
				<tr>
